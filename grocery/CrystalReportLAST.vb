...
Public Class CrystalReportLAST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "grocery.CrystalReportLAST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportLAST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportLAST = New CrystalReportLAST()
        rpt.Site = Me.Site
        Return rpt
    End Function
