...
Public Class cryReportsSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "grocery.cryReportsSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryReportsSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryReportsSummary = New cryReportsSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
